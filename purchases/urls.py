...
urlpatterns = [
    ...
    path('cancel/<int:purchase_id>/', views.stripe_payment_cancel, name='stripe_payment_cancel'),
    path('kakao_cancel/<int:purchase_id>/', views.kakaopay_payment_cancel, name='kakaopay_payment_cancel'),
]
